...
они есть, и откроет панель — её можно пристыковать, как QC Bake и QC Validator.
...
Maya. Панель при каждом открытии спрашивает манифест на GitHub Pages, есть ли версия
